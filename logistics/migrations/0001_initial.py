# Generated by Django 5.2.8 on 2025-12-14 21:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateTimeField(blank=True, default=datetime.datetime.today, null=True)),
                ('due_date', models.DateTimeField(blank=True, default=datetime.datetime.today, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_time', models.DateTimeField(blank=True, default=datetime.datetime.today, null=True)),
                ('quantity', models.IntegerField(blank=True, default=1, null=True)),
                ('owner_name', models.CharField(blank=True, max_length=200, null=True)),
                ('delivery_time', models.DateTimeField(blank=True, null=True)),
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('ACCEPTED', 'Accepted'), ('IN_PROGRESS', 'In Progress'), ('COMPLETED', 'Completed'), ('CANCELLED', 'Cancelled')], default='PENDING', max_length=200)),
